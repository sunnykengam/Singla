    ...
    public partial class NewOrders : ContentPage
    {
        ...
        public NewOrders()
        {
            try
            {
                ...
                if (AppSettings.customerdetail.Count != 0)
                {
                    ...
                    lst.ItemsSource = AppSettings.customerdetail.Take(50);
                }
                else
        ...
        private void Searchbar_TextChanged(object sender, TextChangedEventArgs e)
        {
            try
            {
                ...
                if (data == "")
                {
                    lst.ItemsSource = AppSettings.customerdetail.Take(30);
                }
                else
                {
                    ...
                    if (keyword.Length >= 1)
                    {
                        serchitems = AppSettings.customerdetail.Where(C => C.customername.Contains(keyword.ToUpper()) || C.customercode.ToString().Contains(keyword.ToUpper())).ToList();
