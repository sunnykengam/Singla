...
namespace SinglaApp.Common
{
    public static class AppSettings
    {
        ...
        public static ObservableCollection<CustomerMaster> customerdetail
        {
            get
            {
                if (Application.Current.Properties.ContainsKey("customerdetail"))
                {
                    var customerdetail = Application.Current.Properties["customerdetail"];
                    return (ObservableCollection<CustomerMaster>)customerdetail;
                    // do something with id
                }
                else
                {
        ...
        public static List<SinglaApp.Azure.AppcustInvoice> Invoicedetails
        {
            get
            {
                if (Application.Current.Properties.ContainsKey("Invoicedetails"))
                {
                    ...
                    return (List<SinglaApp.Azure.AppcustInvoice>)customerdetail;
                    // do something with id
                }
                else
                {
