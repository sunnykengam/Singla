    ...
    public partial class CustomerList : ContentPage
    {
        ...
        public CustomerList()
        {
            try
            {
                ...
                var list = Task.Run(async () => await database.Table<CustomerMaster>().ToListAsync()).Result;
                ...
                foreach (var item in list)
                {
                    ...
                    lblcount.Text = Convert.ToString(list.Count);
                ...
                ToastNotification.TostMessage("Total Customers " + list.Count);
        ...
        private async void ViewPendingBills_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                AppSettings.customercode = AppSettings.Custcode;
