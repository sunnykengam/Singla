...
namespace InvoiceManagerAPI
{
    public static class Config
    {
        ...
        {
            public const string InvoiceManagerApi = "InvoiceManagerAPI";
            public const string InvoiceManagerApiError = "InvoiceManagerAPI Error";
        }
        ...
        {
           // writer.Write(message, Category.InvoiceManagerApi, Priority.High);
